...
<div role="tabpanel">
  ...
  <ul class="nav nav-tabs" role="tablist">
    <li role="presentation" class="active"><a href="#account-info" aria-controls="profile" role="tab" data-toggle="tab">Account Info</a></li>
    <%if(!username.equalsIgnoreCase("admin")) {%>
    <li role="presentation"><a href="#orders" aria-controls="home" role="tab" data-toggle="tab">Orders</a></li>
